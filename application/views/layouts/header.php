...
<!--                        </li>-->
                        <li>
                            <a href="<?php echo URL::site('/home');?>"><i class="fa fa-dashboard fa-fw"></i> Accueil</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Clients<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo URL::site('client/list');?>">Liste des clients</a>
                                </li>
                                <li>
                                    <a href="<?php echo URL::site('client/add');?>">Ajouter un client</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo URL::site('parameter/product');?>">Liste des produits</a>
                                </li>
                                <li>
                                    <a href=<?php echo URL::site('product/add');?>>Ajouter un produit</a>
                                </li>
                                <li>
                                    <a href=<?php echo URL::site('parameter/user');?>>Gestion des utilisateurs</a>
                                </li>
                                <li>
